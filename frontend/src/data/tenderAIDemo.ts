...
export const TENDER_AGENT_STEPS: AgentStep[] = [
  ...
  { icon: 'search', message: 'Searching Federal Law No. 12 of 2023 on Government Procurement', duration: 2000 },
...
export const TENDERS: TenderDemo[] = [
  // ---- Education ----
  {
    ...
    similarTenders: [
      ...
      { title: 'ADEK Tablet Phase 2', budgetAED: 45_000_000, actualAED: 44_200_000, overrunPct: -1.8 },
      { title: 'KHDA Smart Classroom Devices', budgetAED: 38_000_000, actualAED: 41_000_000, overrunPct: 7.9 },
      { title: 'Sharjah Education Council Devices', budgetAED: 28_000_000, actualAED: 27_600_000, overrunPct: -1.4 },
    ],
  },
  {
    id: 'edu-consult-01',
    ...
    similarTenders: [
      ...
      { title: 'Abu Dhabi Bilingual Education Advisory', budgetAED: 15_000_000, actualAED: 16_200_000, overrunPct: 8.0 },
  ...
  // ---- Healthcare ----
  {
    ...
    similarTenders: [
      { title: 'Ajman Hospital Expansion 2023', budgetAED: 350_000_000, actualAED: 412_000_000, overrunPct: 17.7 },
      { title: 'RAK Medical Complex Phase 1', budgetAED: 280_000_000, actualAED: 305_000_000, overrunPct: 8.9 },
      { title: 'Fujairah Hospital Renovation', budgetAED: 190_000_000, actualAED: 215_000_000, overrunPct: 13.2 },
      { title: 'UAQ Primary Care Centers (5 sites)', budgetAED: 120_000_000, actualAED: 128_000_000, overrunPct: 6.7 },
    ],
  },
  {
    id: 'hc-goods-01',
    ...
    similarTenders: [
      { title: 'DHA Imaging Equipment 2024', budgetAED: 120_000_000, actualAED: 118_000_000, overrunPct: -1.7 },
      { title: 'SEHA Laboratory Equipment Refresh', budgetAED: 95_000_000, actualAED: 102_000_000, overrunPct: 7.4 },
      { title: 'MoHP Ventilator & ICU Procurement', budgetAED: 55_000_000, actualAED: 54_000_000, overrunPct: -1.8 },
    ],
  },
  ...
  // ---- Energy ----
  {
    ...
    compliance: [
      ...
      { item: 'National Workforce clause included (ICV score >= 30%)', passed: true },
      { item: 'Environmental impact assessment completed', passed: true },
      { item: 'Grid connection & DEWA/EWEC coordination approved', passed: true },
    ...
    similarTenders: [
      ...
      { title: 'Mohammed bin Rashid Solar Park Phase 5', budgetAED: 1_500_000_000, actualAED: 1_580_000_000, overrunPct: 5.3 },
      { title: 'Noor Abu Dhabi Solar Plant', budgetAED: 870_000_000, actualAED: 895_000_000, overrunPct: 2.9 },
      { title: 'DEWA Concentrated Solar Tower', budgetAED: 550_000_000, actualAED: 610_000_000, overrunPct: 10.9 },
    ],
  },
  {
    id: 'en-services-01',
    ...
    similarTenders: [
      { title: 'EWEC Grid Analytics Platform', budgetAED: 68_000_000, actualAED: 71_000_000, overrunPct: 4.4 },
      { title: 'ADNOC Energy Monitoring System', budgetAED: 110_000_000, actualAED: 108_000_000, overrunPct: -1.8 },
      { title: 'DEWA Smart Metering Phase 2', budgetAED: 85_000_000, actualAED: 89_000_000, overrunPct: 4.7 },
    ],
  },
  ...
  // ---- Technology ----
  {
    ...
    similarTenders: [
      { title: 'TDRA Government Cloud Platform', budgetAED: 180_000_000, actualAED: 210_000_000, overrunPct: 16.7 },
      { title: 'Abu Dhabi AI Services Contract', budgetAED: 150_000_000, actualAED: 162_000_000, overrunPct: 8.0 },
      { title: 'Dubai Pulse Data Platform', budgetAED: 95_000_000, actualAED: 105_000_000, overrunPct: 10.5 },
      { title: 'Saudi SDAIA National AI Platform', budgetAED: 280_000_000, actualAED: 315_000_000, overrunPct: 12.5 },
    ],
  },
  {
    id: 'tech-goods-01',
    ...
    similarTenders: [
      { title: 'TDRA Network Security Refresh 2024', budgetAED: 110_000_000, actualAED: 115_000_000, overrunPct: 4.5 },
      { title: 'CBNational Cybersecurity Upgrade', budgetAED: 85_000_000, actualAED: 83_000_000, overrunPct: -2.4 },
      { title: 'ADGM Cyber Infrastructure', budgetAED: 65_000_000, actualAED: 68_000_000, overrunPct: 4.6 },
    ],
  },
  ...
  // ---- Economy ----
  {
    ...
    similarTenders: [
      ...
      { title: 'Abu Dhabi Economic Vision Review', budgetAED: 40_000_000, actualAED: 42_000_000, overrunPct: 5.0 },
      { title: 'Dubai Economy Strategy Consultancy', budgetAED: 22_000_000, actualAED: 24_500_000, overrunPct: 11.4 },
    ],
  },
  {
    id: 'econ-services-01',
    ...
    similarTenders: [
      { title: 'MoEC Digital Trade Platform 2024', budgetAED: 52_000_000, actualAED: 54_000_000, overrunPct: 3.8 },
      { title: 'Khalifa Fund SME Portal', budgetAED: 35_000_000, actualAED: 36_200_000, overrunPct: 3.4 },
      { title: 'Dubai SME Digital Marketplace', budgetAED: 48_000_000, actualAED: 47_000_000, overrunPct: -2.1 },
  ...
  // ---- Defense ----
  {
    ...
    similarTenders: [
      { title: 'MoI Border Security Phase 2 (2023)', budgetAED: 720_000_000, actualAED: 795_000_000, overrunPct: 10.4 },
      { title: 'Abu Dhabi Police Surveillance Upgrade', budgetAED: 450_000_000, actualAED: 488_000_000, overrunPct: 8.4 },
      { title: 'Oman Border Modernization Program', budgetAED: 650_000_000, actualAED: 710_000_000, overrunPct: 9.2 },
      { title: 'Saudi GAMI Border Systems', budgetAED: 1_100_000_000, actualAED: 1_250_000_000, overrunPct: 13.6 },
    ],
  },
  {
    id: 'def-goods-01',
    ...
    similarTenders: [
      ...
      { title: 'EDGE Group Drone Systems Contract', budgetAED: 290_000_000, actualAED: 305_000_000, overrunPct: 5.2 },
      { title: 'Saudi SAMI UAS Procurement', budgetAED: 620_000_000, actualAED: 680_000_000, overrunPct: 9.7 },
    ],
  },
];
...
export const TENDER_PIPELINE: TenderPipelineItem[] = [
  ...
  {
    id: 'pip-003',
    title: 'Abu Dhabi Public Schools HVAC Modernization',
    ministry: 'Ministry of Education',
...
export const REASONING_TRACE: ReasoningStep[] = [
  {
    ...
    finding: 'Tender classified as federal goods procurement (above $5M threshold). Primary regulation: Federal Law No. 12 of 2023 on Government Procurement, Articles 18-24 (Competitive Bidding). Secondary: Cabinet Decision No. 32 of 2023 on procurement procedures.',
    sources: ['Federal Law No. 12/2023', 'Cabinet Decision No. 32/2023', 'National Procurement Portal classification'],
    confidence: 0.97,
  },
  {
    step: 2,
    ...
    sources: ['Federal Law No. 12/2023 Arts. 20-38', 'ICV Program Guidelines 2024', 'Federal Procurement Manual Ch. 4'],
    confidence: 0.95,
  },
  {
    step: 3,
    ...
    sources: ['Tender document analysis', 'Federal Law No. 12/2023 Art. 35(c)', 'National Public Procurement Policy 2024'],
    confidence: 0.92,
  },
  {
    step: 4,
