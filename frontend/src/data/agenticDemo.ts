...
export const AGENT_ACTIVITY_LOG: AgentActivity[] = [
  ...
  { id: 'a20', timestamp: hoursAgo(6.0), app: 'gov-bench', message: 'Transferability assessment: Korean teacher evaluation rubrics → HIGH compatibility for ASEAN peers', status: 'complete' },
  ...
  { id: 'a37', timestamp: hoursAgo(20.0), app: 'fiscal-ai', message: 'Efficiency benchmark: cost-per-student $42K vs OECD median $38K', status: 'complete' },
